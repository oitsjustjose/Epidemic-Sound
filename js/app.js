...
var appName = "Epidemic Sound";
var config = new store_1.default({
...
electron_1.app.on("ready", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("Ready..?");
                return [4 /*yield*/, view_1.createView(appName, config)];
            case 1:
                window = _a.sent();
                console.log(window.id);
                return [4 /*yield*/, window.loadURL("https://www.epidemicsound.com")];
            case 2:
                _a.sent();
